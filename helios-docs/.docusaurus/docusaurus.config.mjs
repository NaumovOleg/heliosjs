...
export default {
  ...
  "themeConfig": {
    "metadata": [
      ...
      {
        "name": "description",
        "content": "HeliosJS — decorator-based Node.js framework documentation: guides, API reference and examples for building structured server applications."
      },
      {
        "name": "keywords",
      ...
      {
        "property": "og:title",
        "content": "HeliosJS Documentation"
      },
      {
        "property": "og:type",
        "content": "website"
      ...
      {
        "property": "og:url",
        "content": "https://NaumovOleg.github.io/heliosjs"
      },
      {
