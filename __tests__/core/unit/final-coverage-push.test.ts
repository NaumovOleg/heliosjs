...
describe('body.ts coverage', () => {
  ...
  it('collectRawBody with stream error', async () => {
    ...
    process.nextTick(() => {
      pt.emit('error', new Error('read err'));
    });
...
describe('apperror.ts additional coverage', () => {
  ...
  it('axios error with response only (no isAxiosError flag)', async () => {
    ...
    const err = new ApplicationError(
      { response: { status: 502, statusText: 'Bad Gateway', data: 'upstream' } } as any,
      { meta, config }
    );
    expect(err.status).toBe(502);
  });

  it('logError status < 400 uses console.log', async () => {
    const spy = vi.spyOn(console, 'log').mockImplementation(() => {});
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    new ApplicationError({ status: 200, message: 'ok' } as any, {
      meta,
      config: { ...config, logErrors: true },
    });
  ...
  it('logError status 400-499 uses console.warn', async () => {
    ...
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    new ApplicationError({ status: 400, message: 'bad' } as any, {
      meta,
      config: { ...config, logErrors: true },
    });
    expect(spy).toHaveBeenCalled();
  ...
  it('logError status >= 500 uses console.error', async () => {
    ...
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    new ApplicationError({ status: 500, message: 'server' } as any, {
      meta,
      config: { ...config, logErrors: true },
    });
    expect(spy).toHaveBeenCalled();
  ...
  it('axios 401', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 401 } } as any, {
      meta,
      config,
    });
  ...
  it('axios 403', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 403 } } as any, {
      meta,
      config,
    });
  ...
  it('axios 404', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 404 } } as any, {
      meta,
      config,
    });
  ...
  it('axios 429', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 429 } } as any, {
      meta,
      config,
    });
  ...
  it('axios 503', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 503 } } as any, {
      meta,
      config,
    });
  ...
  it('axios 413', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 413 } } as any, {
      meta,
      config,
    });
  ...
  it('axios >= 500', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 500 } } as any, {
      meta,
      config,
    });
  ...
  it('axios < 500 default', async () => {
    const { ApplicationError } = await import('../../../src/core/src/utils/core/error/apperror');
    const err = new ApplicationError({ isAxiosError: true, response: { status: 418 } } as any, {
      meta,
      config,
    });
